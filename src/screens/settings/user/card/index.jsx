...
const UserCard = ({ data, user_id, onUserChange, onUserDelete, flag = false }) => {
    const RenderCard = ({ item }) => (
        <Stack horizontal flex={1} status={item.status === 1 ? theme.colors.green[600] : theme.colors.gray[100]} paddingHorizontal={8} backgroundColor={theme.colors.gray[1]}
            ...
            <XStack flex={1} justifyContent='flex-end' alignItems='center'>
                ...
                <StyledCycle borderWidth={1} borderColor={theme.colors.gray[400]}>
                    <StyledMIcon size={32} name='delete-outline' color={theme.colors.gray[600]} onPress={() => {
                        ...
                        if (onUserDelete) onUserDelete(item.user_id);
                    }} />
                </StyledCycle>
            </XStack>
        </Stack>
