...
const SETTINGS_CONFIG = {
  rows: [
    ...
    [
      ...
      {
        id: 'shop',
        icon: require('../../../assets/img/shop-1.png'),
        name: 'Shop',
      },
    ],
    [
      ...
      {
        id: 'restore',
        icon: require('../../../assets/img/restore-1.png'),
        name: 'Restore',
      },
      {
        id: 'printer',
        icon: require('../../../assets/img/report-2.png'),
        name: 'Printer',
      },
    ],
  ],
  ...
  return (
    <StyledPage backgroundColor={theme.colors.gray[100]}>
      ...
      <Drawer
        ...
        {show.tag === 'back-up' && <Backup></Backup>}
        {show.tag === 'restore' && <Restore></Restore>}
        {show.tag === 'printer' && (
