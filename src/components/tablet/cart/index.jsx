...
export default function Cart({table_id, table_name}) {
  ...
  const renderOrderSummary = () => (
    <Box
      ...
      <Box height={1} backgroundColor={theme.colors.gray[800]} my={12} />
  ...
  return (
    <VStack
      ...
      <Drawer visible={showPayment} bodyStyle={{ backgroundColor: theme.colors.gray[800] }} onClose={() => setShowPayment(false)} title="60% wide" width="30%" side="right">
        <Payment
