...
const TILES: TileConfig[] = [
  {key: 'Progress', label: 'In progress', barColor: '#f59e0b', bgColor: '#fffbeb', numColor: '#92400e', lblColor: '#b45309', dotBg: '#fde68a', dotColor: '#f59e0b'},
  {key: 'Completed', label: 'Completed',  barColor: '#22c55e', bgColor: '#f0fdf4', numColor: '#166534', lblColor: '#15803d', dotBg: '#bbf7d0', dotColor: '#22c55e'},
  {key: 'Cancelled', label: 'Cancelled',  barColor: '#ef4444', bgColor: '#fff5f5', numColor: '#991b1b', lblColor: '#b91c1c', dotBg: '#fecaca', dotColor: '#ef4444'},
];
...
const Tile = ({label, bgColor, numColor, lblColor, dotBg, dotColor, value, t}: TileProps) => (
  <Stack flex={1} vertical borderRadius={12} overflow="hidden"
    ...
    <Stack
      ...
      backgroundColor={bgColor} paddingHorizontal={16} paddingVertical={14}>
      ...
      <Stack width={44} height={44} borderRadius={22}
